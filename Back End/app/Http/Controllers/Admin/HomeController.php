...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $sellProductList = DB::table("sell_details")
            ...
            ->select('products.id', 'products.name', DB::raw("SUM(sell_details.sale_quantity) as total_sell"))
            ->groupBy('products.id', 'products.name' /*, Add other grouped fields from products */)
